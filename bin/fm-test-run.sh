...
family_for_basename() {
  case "$1" in
    ...
    fm-spawn-claude-account.test.sh|fm-spawn-dispatch-profile.test.sh|\
...
tests/fm-spawn-claude-account.test.sh 20000
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-composer-lib.sh)
      ...
      printf '%s\n' live-harness-optin
      ;;
    bin/fm-spawn.sh|bin/fm-send.sh|bin/fm-harness.sh|bin/fm-claude-account-lib.sh|\
