...
config/claude-config-dir  optional Claude login folder (absolute path or "default") for claude agents this home launches; LOCAL, gitignored, NOT inherited; each launch records it so relaunch and recovery keep that account; see docs/configuration.md "Claude account"
